...
int buildEncodingTree(int nextFree) {
    ...
    //    - Create a new parent node with combined weight
        ...
        weightArr[parentIdx] = weightArr[left] + weightArr[right];
    //    - Set left/right pointers
        leftArr[parentIdx] = left;
        rightArr[parentIdx] = right;
        charArr[parentIdx] = '\0';
